  ...
  t.test('version', function (t) {
    ...
    stream.write({
      ...
      payload: {
        ...
        nonce: Buffer.from('dd9d202c3ab45713', 'hex'),
        userAgent: '',
        startHeight: 98645,
        relay: false
      }
  ...
  t.test('tx', function (t) {
    ...
    stream.write({
      ...
      payload: {
        ...
        ins: [
          {
            hash: Buffer.from('6dbddb085b1d8af75184f0bc01fad58d1266e9b63b50881990e4b40d6aee3629', 'hex'),
            index: 0,
            script: Buffer.from('', 'hex'),
            sequence: 4294967295
          }
        ],
        outs: [
          {
            valueBuffer: Buffer.from('404b4c0000000000', 'hex'),
            script: Buffer.from('76a9141aa0cd1cbea6e7458a7abad512a9d9ea1afb225e88ac', 'hex')
          },
          {
            valueBuffer: Buffer.from('80fae9c700000000', 'hex'),
            script: Buffer.from('76a9140eab5bea436a0484cfab12485efda0b78b4ecc5288ac', 'hex')
          }
        ],
        locktime: 0
      }
